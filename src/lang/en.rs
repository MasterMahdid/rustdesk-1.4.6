...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use KariyaDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade KariyaDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent KariyaDesk from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if KariyaDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep KariyaDesk background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the KariyaDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, KariyaDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, KariyaDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, KariyaDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: KariyaDesk server OSS doesn't include this feature."),
