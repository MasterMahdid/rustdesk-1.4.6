...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای KariyaDesk برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز KariyaDesk برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز KariyaDesk برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی KariyaDesk شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"KariyaDesk Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep RustDesk background service", "را در پس زمینه نگه دارید KariyaDesk سرویس"),
        ...
        ("Show RustDesk", "KariyaDesk نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز KariyaDesk \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. KariyaDesk \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای KariyaDesk کلیک کند."),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور کاریادسک را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید KariyaDesk اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید KariyaDesk Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند KariyaDesk روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("powered_by_me", "Powered by KariyaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود KariyaDesk زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند کاریادسک این به حفظ سرویس پس زمینه"),
        ...
        ("About RustDesk", "KariyaDesk درباره"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً KariyaDesk را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، KariyaDesk گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، KariyaDesk دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، KariyaDesk دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور KariyaDesk OSS این ویژگی را ندارد."),
